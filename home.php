<section class="hero">
    <div class="hero-content">
        ...
        <a href="?category=badminton" class="btn-primary">Explore All <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
    </div>
</section>
